-- Go competitive-programming snippets.
-- Each mapping inserts a classic algorithm / data-structure template
-- at the cursor. Keymaps are defined at the bottom of this file.
...
-- Keymaps
-- sort algos
vim.keymap.set("n", "<leader>qs", InsertQuickSortSnippet, { silent = true, desc = "Go snippet: quick sort" })
vim.keymap.set("n", "<leader>ms", InsertMergeSortSnippet, { silent = true, desc = "Go snippet: merge sort" })
vim.keymap.set("n", "<leader>hs", InsertHeapSortSnippet, { silent = true, desc = "Go snippet: heap sort" })
vim.keymap.set("n", "<leader>cs", InsertCountingSortSnippet, { silent = true, desc = "Go snippet: counting sort" })
vim.keymap.set("n", "<leader>rs", InsertRadixSortSnippet, { silent = true, desc = "Go snippet: radix sort" })
-- search algos
vim.keymap.set("n", "<leader>bs", InsertBinarySearchSnippet, { silent = true, desc = "Go snippet: binary search" })
vim.keymap.set("n", "<leader>dfs", InsertDFSSnippet, { silent = true, desc = "Go snippet: DFS (graph)" })
vim.keymap.set("n", "<leader>bfs", ImportBFSSnippet, { silent = true, desc = "Go snippet: BFS (graph)" })
-- dfs algo for matrix
vim.keymap.set("n", "<leader>dfsm", ImportDFSSnippet, { silent = true, desc = "Go snippet: DFS (matrix)" })
vim.keymap.set("n", "<leader>bfsm", ImportBFSMatrixSnippet, { silent = true, desc = "Go snippet: BFS (matrix)" })
-- graph
vim.keymap.set("n", "<leader>gdi", ImportDijkstra, { silent = true, desc = "Go snippet: dijkstra" })
vim.keymap.set("n", "<leader>gbel", ImportBellmanFord, { silent = true, desc = "Go snippet: bellman ford" })
vim.keymap.set("n", "<leader>gflw", ImportFloydWarshall, { silent = true, desc = "Go snippet: floyd warshall" })
vim.keymap.set("n", "<leader>gka", ImportKruskalAlgorithm, { silent = true, desc = "Go snippet: kruskal" })
vim.keymap.set("n", "<leader>gpa", ImportPrimesAlgorithm, { silent = true, desc = "Go snippet: primes" })
vim.keymap.set(
	"n",
	"<leader>gto",
	ImportTopologicalSortAlgorithm,
	{ silent = true, desc = "Go snippet: topological sort" }
)
-- - SCCs
vim.keymap.set("n", "<leader>gta", ImportTarjanAlgorithm, { silent = true, desc = "Go snippet: tarjan" })
-- Dynamic programming
vim.keymap.set("n", "<leader>dks", ImportKnapsackAlgorithm, { silent = true, desc = "Go snippet: knapsack" })
vim.keymap.set("n", "<leader>dlcs", ImportLCS, { silent = true, desc = "Go snippet: LCS" })
vim.keymap.set("n", "<leader>dles", ImportLIS, { silent = true, desc = "Go snippet: LIS" })
vim.keymap.set("n", "<leader>dmc", ImportMinimomCoinChange, { silent = true, desc = "Go snippet: minimum coin change" })
vim.keymap.set(
	"n",
	"<leader>dmm",
	ImportMatrixChainMultiplication,
	{ silent = true, desc = "Go snippet: matrix chain multiplication" }
)
vim.keymap.set(
	"n",
	"<leader>ded",
...
-- data structures
vim.keymap.set("n", "<leader>qu", ImportQueue, { silent = true, desc = "Go snippet: queue" })
vim.keymap.set("n", "<leader>st", ImportStack, { silent = true, desc = "Go snippet: stack" })
vim.keymap.set("n", "<leader>lli", ImportLinkedList, { silent = true, desc = "Go snippet: linked list" })
vim.keymap.set("n", "<leader>pq", ImportPQ, { silent = true, desc = "Go snippet: priority queue" })
vim.keymap.set("n", "<leader>dsu", ImportDSU, { silent = true, desc = "Go snippet: DSU" })
